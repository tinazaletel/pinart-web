# CLAUDE.md — pravila za Claude Code na tem projektu

Ta datoteka velja za Claude Code (in vse podobne AI agente), ki delajo
...
- Ne uporabljaj emojijev v kodi razen, če uporabnica eksplicitno prosi
...
## 5. Komunikacijska pravila (specifika Tina)

- Govori v slovenščini, razen če uporabnica preklopi na drug jezik
- Pred pisanjem kode počakaj na eksplicitno potrditev ("da", "ok", "gremo")
- Ne spreminjaj fiksnih vrednosti (ki jih je uporabnica že popravila)
  brez izrecnega navodila
- Pri "match X" zamenjuj ozko (samo poimenovan podsistem), ohrani bespoke
  oblikovalske elemente
- Privzeto posnemaj Codex obnašanje — ne razširjaj funkcionalnosti brez
  vprašanja
