...
export default async function RacuniPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return <main className={styles.shell}><DashboardSidebar base={base} active="invoices" /><section className={styles.workspace}><header className={styles.topbar}><div><p className={styles.eyebrow}>RAČUNI</p><h1>Od dogovora do plačila.</h1></div><DashboardHeaderTools /></header><InvoiceWorkspace base={base} /></section></main>;
}
