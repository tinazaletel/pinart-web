    ...
    >
      ...
      <section className="case-hero">
        <div className="case-hero__top">
          <p className="eyebrow">
            Selected Work · <span style={{ color: 'var(--accent)' }}>№ 01</span> · 2024
          </p>
          <BlurText
            tag="h1"
        ...
        <div className="case-hero__bottom">
          <p className="case-lede">
            Začelo se je z logom. Končalo se je z družino kartic, ki gori v žepu —
            in portalom, kjer jih naročiš v <strong>treh klikih</strong>.
          </p>
          <div className="case-meta-inline">
            <div>
              Role <span>Branding · Card · Web</span>
            </div>
            <div>
              Year <span>2023 — 2024</span>
            </div>
            <div>
              For <span>Petrol d.d.</span>
            </div>
          </div>
        </div>
      ...
      <section className="case-section intro">
        <div className="intro__left">
          ...
          <h2 className="head-title">
            Nov plačilni brand
            <br />
            za največjega slovenskega <em>trgovca z gorivom.</em>
          </h2>
        </div>
        <div className="intro__right">
          <div className="intro__body">
            <p>
              <strong>Petrol Pay</strong> je plačilna in zvestobna kartična shema,
              ki jo Petrol uvaja kot svoj lasten finančni produkt — od osebne
              Loyalty kartice do Klub in Business različic.
            </p>
            <p>
              Naloga: postaviti vizualno identiteto, ki <em>diha s krovno znamko</em>,
              hkrati pa stoji samostojno. Logo, paleta, tipografija,{' '}
              <strong>šest predlogov kartic</strong> — od katerih je ena šla v
              produkcijo — in portal za naročanje s SVG animacijami in uvodnim
              videom.
            </p>
          </div>
          ...
          <div className="intro__meta-grid">
            <div className="meta-cell">
              <div className="meta-cell__label">Role</div>
              <div className="meta-cell__value">
                Branding<br />Card design<br />UX &amp; UI
              </div>
            </div>
            <div className="meta-cell">
              <div className="meta-cell__label">Year</div>
              <div className="meta-cell__value">2023 — 2024</div>
            </div>
            <div className="meta-cell">
              <div className="meta-cell__label">For</div>
              <div className="meta-cell__value">
                Petrol d.d.
                <em>in partnership with Mastercard</em>
              </div>
            </div>
            <div className="meta-cell">
              <div className="meta-cell__label">Status</div>
              <div className="meta-cell__value">
                Selected card<br />in production
                <em>portal — phased rollout</em>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="case-section logo-system">
        <div className="logo-system__head">
          <p className="head-label">
            <span className="head-label__num">03</span> · Identity
          </p>
          <h2 className="head-title">
            A mark that reads <em>from a pump</em>
            <br />
            and from a phone.
          </h2>
        </div>
      ...
      <section className="case-section cards-section">
        <div className="cards-section__head">
          <p className="head-label">
            <span className="head-label__num">04</span> · The Family
          </p>
          <h2 className="cards-title">
            Three cards.
            <br />
            One <em>quiet</em> language.
          </h2>
          <p className="cards-sub">
            Šest predlogov, en izbor — gold za vse, ki vozijo na svoji poti.
            Klub za zveste. Business za tiste, ki vozijo službeno.
          </p>
        </div>
        ...
        <div className="cards-grid">
          <div className="card-slot">
            ...
            <div className="card-slot__name">
              Klub <em>Pay</em>
            </div>
            <div className="card-slot__meta">Loyalty · Gold</div>
          </div>
          <div className="card-slot">
            ...
            <div className="card-slot__name">Klub</div>
            <div className="card-slot__meta">Loyalty · Silver</div>
          </div>
          <div className="card-slot">
            ...
            <div className="card-slot__name">Business</div>
            <div className="card-slot__meta">Corporate · Monogram</div>
          </div>
        </div>
      </section>
      ...
      <section className="case-section numbers-strip">
        <div>
          ...
          <div className="numbers-label">Proposals</div>
          <div className="numbers-desc">
            Razvitih konceptov kartic, od minimalnih do iridescent. Eno so izbrali.
          </div>
        </div>
        <div>
          <div className="numbers-num">213</div>
          <div className="numbers-label">Pages CGP</div>
          <div className="numbers-desc">
            Strani celovitega grafičnega priročnika za znamko in njeno uporabo.
          </div>
        </div>
        <div>
          <div className="numbers-num">
          ...
          <div className="numbers-label">Portal screens</div>
          <div className="numbers-desc">
            UX in UI ekranov za PKPK portal — naročilo, registracija, podpora.
          </div>
        </div>
      </section>
      ...
      <section className="case-section variations">
        <div className="variations__head">
          <p className="head-label">
            <span className="head-label__num">04½</span> · The Exploration
          </p>
          <h2 className="head-title">
            Pred izborom: <em>razgledana eksploracija.</em>
          </h2>
          <p className="cards-sub" style={{ color: 'var(--ink-soft)', marginTop: 24, maxWidth: 720 }}>
            Klient je izbral pokončno smer, vendar so med procesom nastale tudi
            te variante — od valovnega holograma do digitalnih pikslov in
            ilustrativnih scen. Vsaka pripoveduje malce drugo zgodbo.
          </p>
        </div>
        ...
        <div className="variations__grid">
          <figure className="variations__item">
            ...
            />
            <figcaption>Business · Waves</figcaption>
          </figure>
          <figure className="variations__item">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
            ...
            />
            <figcaption>Klub · Maze</figcaption>
          </figure>
          <figure className="variations__item">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
            ...
            />
            <figcaption>Business · Pixel</figcaption>
          </figure>
          <figure className="variations__item">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
            ...
            />
            <figcaption>Klub Pay · Horizon</figcaption>
          </figure>
        </div>
      </section>
      ...
      <section className="case-section brand-apps">
        <div className="brand-apps__head">
          <p className="head-label">
            <span className="head-label__num">04¾</span> · Brand in use
          </p>
          <h2 className="head-title">
            Od koncepta do <em>otipljive aplikacije.</em>
          </h2>
          <p className="cards-sub" style={{ color: 'var(--ink-soft)', marginTop: 24, maxWidth: 720 }}>
            Predstavljena je <strong>primarna smer ilustracije</strong> z
            vetrnicami in električnim avtom. Tik pred lansiranjem se je logo
            partnerja zamenjal v Visa, vendar tu prikazujem primarno verzijo,
            ki mi je bila estetsko bolj všeč in najbolje zaobjame karakter
            znamke.
          </p>
        </div>
        ...
        <div className="brand-apps__grid">
          <div className="brand-apps__video">
            <video
              ...
              playsInline
            />
            <div className="brand-apps__caption">Real product · v roki</div>
          </div>
          <figure className="brand-apps__item brand-apps__item--tshirt">
            ...
            />
            <figcaption>Majica · Petrol team</figcaption>
          </figure>
          <figure className="brand-apps__item brand-apps__item--wide">
            ...
            />
            <figcaption>Potrebščine · Brand collateral</figcaption>
          </figure>
        </div>
      </section>
      ...
      <section className="case-section portal">
        <div className="portal__head">
          <p className="head-label">
            <span className="head-label__num">05</span> · The Portal
          </p>
          <h2 className="head-title">
            PKPK <em>—</em> tri klike do kartice.
          </h2>
          <p className="cards-sub" style={{ color: 'var(--ink-soft)', marginTop: 24 }}>
            Responsive web portal za naročilo Petrol Pay kartice. SVG animacije,
            kratek uvodni video, intuitivni flow od pozdrava do potrditve.
          </p>
        </div>
      ...
      <section className="case-section next-case">
        <div className="next-case__small">Next case</div>
        <h2 className="next-case__title">
          mBills<em>.</em>
        </h2>
