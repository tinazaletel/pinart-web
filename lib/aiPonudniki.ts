...
export const AI_PONUDNIKI = [
  { id: 'openai', ime: 'OpenAI (ChatGPT)', model: 'gpt-4.1-mini',
    ...
    korakiSl: ['Odpri platform.openai.com in se prijavi z računom, ki ga že uporabljaš za ChatGPT.',
               'V LEVEM stolpcu klikni »API Keys« (ključek, pod Codex).',
               'Klikni črni gumb »Create new secret key«, poimenuj ga npr. »Pinart Flow« in potrdi.',
               'Kopiraj ključ (začne se s sk-). Pokaže se SAMO enkrat — ko okno zapreš, ga ni več.',
               'Nalij dobroimetje: levo spodaj »Add credits« → »Go to Billing«. Naročnina na ChatGPT Plus tu NE velja — API se plačuje ločeno po porabi (pet dolarjev zdrži zelo dolgo).'],
    korakiEn: ['Open platform.openai.com and sign in with the account you use for ChatGPT.',
               'In the LEFT sidebar click “API Keys” (key icon, under Codex).',
               'Click the black “Create new secret key” button, name it e.g. “Pinart Flow” and confirm.',
               'Copy the key (starts with sk-). It is shown ONLY once — close the dialog and it is gone.',
               'Add credit: bottom left “Add credits” → “Go to Billing”. A ChatGPT Plus subscription does NOT cover the API — it is billed separately per use.'] },
