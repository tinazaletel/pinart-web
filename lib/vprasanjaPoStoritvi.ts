 ...
 */
/* Splosni »ali dopiši«: povsod, kjer vprasanje ponuja izbire, mora biti mozen
   tudi svoj odgovor — stranka se ne ujema vedno z nasimi predalcki (Tina,
   26. 8. 2026). Konstanta zato, da je angleski prevod na ENEM mestu
   (KalkulatorApp: VPRASANJA_EN fallback). */
export const SVOJE_SPLOSNO = 'ali dopiši …';
...
export const VPRASANJA_PO_STORITVI: Record<string, ProjektnoVprasanje[]> = {
  ...
  web: [
    { id: 'ima-cgp', label: 'Ali ima naročnik celostno grafično podobo (CGP)?', izbire: ['Da, upoštevam obstoječo', 'Ne, oblikujem svobodno', 'Ne, potrebuje tudi novo CGP'], svoje: SVOJE_SPLOSNO },
    { id: 'tip', label: 'Kaj ustvarjamo ali prenavljamo?', izbire: ['Nova spletna stran', 'Prenova (redesign)', 'Landing page', 'Portfolio', 'Spletna trgovina', 'Custom aplikacija'], vec: true, svoje: SVOJE_SPLOSNO },
    ...
    { id: 'fonti', label: 'Pisave: je licenca za splet (webfont) urejena?', izbire: ['Da, imamo webfont licenco', 'Uporabimo Google Fonts / odprtokodne', 'Treba jo bo urediti', 'Ne vem še'], svoje: SVOJE_SPLOSNO },
  ],
  kampanja: [
    ...
    { id: 'regija', label: 'Katero regijo pokriva?', izbire: ['Lokalno', 'Slovenija', 'Adria regija', 'EU', 'Globalno'], vec: true, svoje: SVOJE_SPLOSNO },
    { id: 'influencerji', label: 'Ali vključimo influencerje?', izbire: ['Da', 'Ne', 'Morda'], svoje: 'kateri, če že veš ...' },
    { id: 'email', label: 'Ali potrebuješ tudi email marketing (newsletter)?', izbire: ['Da, kot posebna postavka', 'Ne', 'Še ne vem'], svoje: SVOJE_SPLOSNO },
  ...
  publikacija: [
    ...
    { id: 'izhod', label: 'Za tisk, digital ali oboje?', izbire: ['PDF za tisk', 'PDF za splet', 'ePub', 'Interaktivni PDF'], vec: true, svoje: SVOJE_SPLOSNO },
    { id: 'strani', label: 'Koliko strani (okvirno)?', izbire: ['Do 8', '9 do 32', '33 do 96', 'Nad 96'], svoje: 'ali vpiši ...' },
    { id: 'besedila', label: 'Ali so besedila pripravljena in lektorirana?', izbire: ['Da, lektorirana', 'Pripravljena, brez lekture', 'Še nastajajo'], svoje: SVOJE_SPLOSNO },
    { id: 'slike', label: 'Ali so slike in grafike že pripravljene?', izbire: ['Da, vse imamo', 'Delno', 'Še nič'], svoje: SVOJE_SPLOSNO },
    ...
    { id: 'fonti', label: 'Pisave: so licence urejene za predvideno rabo (tisk/splet/app)?', izbire: ['Naročnik jih ima za to rabo', 'Treba jih bo kupiti / nadgraditi', 'Uporabimo odprtokodne (npr. Google Fonts)', 'Ne vem še'], svoje: SVOJE_SPLOSNO },
    { id: 'jeziki', label: 'Koliko jezikovnih različic?', izbire: ['1', '2', '3 ali več'], svoje: SVOJE_SPLOSNO },
    { id: 'naklada', label: 'Predvidena naklada tiska?', izbire: ['Samo digital', 'Do 100', '100 do 500', 'Nad 500'], svoje: 'ali vpiši ...' },
    { id: 'proof', label: 'Ali potrebujete tiskarski proof (poskusni odtis)?', izbire: ['Da', 'Ne', 'Ne vem še'], svoje: SVOJE_SPLOSNO },
    { id: 'tisk', label: 'Vključimo pripravo za tisk in komunikacijo s tiskarjem?', izbire: ['Da, vključi', 'Ne, uredijo sami'], svoje: SVOJE_SPLOSNO },
  ...
  embalaza: [
    ...
    { id: 'tehnika', label: 'Ali že obstaja dieline / tehnična skica?', izbire: ['Da, obstaja', 'Treba jo bo izdelati', 'Ne vem še'], svoje: SVOJE_SPLOSNO },
    { id: 'trg', label: 'Kje se bo izdelek prodajal?', izbire: ['Splet', 'Trgovine', 'Premium butik', 'HoReCa', 'Lekarne'], vec: true, svoje: 'dopiši ...' },
    { id: 'oznake', label: 'Zakonske oznake (deklaracije, sestavine)?', izbire: ['Pripravljene', 'Treba jih bo urediti', 'Ne vem še'], svoje: SVOJE_SPLOSNO },
  ...
  ilustracija: [
    ...
    { id: 'barvnost', label: 'Črtne ali barvne?', izbire: ['Črtne', 'Barvne', 'Oboje'], svoje: SVOJE_SPLOSNO },
  ...
  direkcija: [
    ...
    { id: 'srecanja', label: 'Kako pogosta srečanja?', izbire: ['Tedensko', 'Mesečno', 'Po potrebi'], svoje: SVOJE_SPLOSNO },
  ...
  fotografija: [
    ...
    { id: 'lokacija', label: 'Kje?', izbire: ['V studiu', 'Pri naročniku', 'Na zunanji lokaciji', 'Več lokacij'], svoje: SVOJE_SPLOSNO },
    { id: 'najem', label: 'Bo treba najeti studio, opremo ali lokacijo?', izbire: ['Ne', 'Da, studio', 'Da, luči / opremo', 'Da, lokacijo', 'Ne vem še'], vec: true, svoje: SVOJE_SPLOSNO },
    /* Fotografi ne delajo krogov popravkov kot oblikovalci — dogovorijo se za
       PAKET: koliko obdelanih fotografij in koliko retus je vkljucenih. Po
       snemanju narocnik izbere. Popravki so mozni, a redki (Tina, 2. 9. 2026;
       potrdi Tadej). */
    { id: 'post', label: 'Koliko obdelanih fotografij je v paketu?', izbire: ['Do 20', '30', '50', 'Nad 50'], svoje: 'ali vpiši število ...' },
    { id: 'retuse', label: 'Koliko zahtevnih retuš je vključenih?', izbire: ['Brez, samo osnovna obdelava', 'Do 3', 'Do 6', '10 ali več'], svoje: 'ali vpiši število ...' },
    { id: 'raba', label: 'Kje se bodo uporabljale?', izbire: ['Splet / social', 'Tisk', 'Oglaševanje'], vec: true, svoje: SVOJE_SPLOSNO },
  ...
  copy: [
    ...
    { id: 'seo', label: 'SEO optimizacija?', izbire: ['Da', 'Ne', 'Svetuj mi'], svoje: SVOJE_SPLOSNO },
    { id: 'jeziki', label: 'V katerih jezikih?', izbire: ['Slovenščina', 'Slovenščina + angleščina', 'Več jezikov'], svoje: 'kateri ...' },
    { id: 'gradiva', label: 'Kakšna so izhodišča?', izbire: ['Imajo iztočnice', 'Potreben intervju', 'Začnemo iz nič'], svoje: SVOJE_SPLOSNO },
    { id: 'budget', label: 'Okvirni budget naročnika?', izbire: ['Do 500 €', '500 do 1.500 €', 'Nad 1.500 €', 'Še ne vem'], svoje: 'ali vpiši svoj znesek ...' },
    { id: 'opomba', label: 'Opomba (neobvezno)', placeholder: 'karkoli, kar naj upoštevam vnaprej ...' },
  ],
  interier: [
    ...
    { id: 'faza', label: 'V kateri fazi je projekt?', izbire: ['Novogradnja (napeljave fiksne)', 'Prenova (spremembe prostorov/napeljav)', 'Samo oprema / styling', 'Mizarsko / pohištvo po meri'], svoje: SVOJE_SPLOSNO },
  ...
  razstava: [
    ...
    { id: 'storitve', label: 'Kaj vključuje?', izbire: ['Koncept', 'Tlorisi', '3D vizualizacije', 'Grafika', 'Nadzor postavitve'], vec: true, svoje: SVOJE_SPLOSNO },
    { id: 'trajanje', label: 'Koliko časa stoji?', izbire: ['Enkraten dogodek', 'Do 1 mesec', 'Stalna postavitev'], svoje: SVOJE_SPLOSNO },
    { id: 'budget', label: 'Okvirni budget naročnika?', izbire: ['Do 2.000 €', '2.000 do 6.000 €', 'Nad 6.000 €', 'Še ne vem'], svoje: 'ali vpiši svoj znesek ...' },
    { id: 'opomba', label: 'Opomba (neobvezno)', placeholder: 'karkoli, kar naj upoštevam vnaprej ...' },
  ],
  produktni: [
    ...
    { id: 'storitve', label: 'Kaj vključuje?', izbire: ['Koncept', 'Tehnična dokumentacija', '3D model', 'Prototip', 'Nadzor proizvodnje'], vec: true, svoje: SVOJE_SPLOSNO },
    { id: 'proizvodnja', label: 'Je proizvajalec znan?', izbire: ['Da', 'Ne', 'Iščemo ga'], svoje: SVOJE_SPLOSNO },
    { id: 'budget', label: 'Okvirni budget naročnika?', izbire: ['Do 2.000 €', '2.000 do 6.000 €', 'Nad 6.000 €', 'Še ne vem'], svoje: 'ali vpiši svoj znesek ...' },
    { id: 'opomba', label: 'Opomba (neobvezno)', placeholder: 'karkoli, kar naj upoštevam vnaprej ...' },
  ],
  uxui: [
    ...
    { id: 'storitve', label: 'Kaj vključuje?', izbire: ['UX raziskava', 'Uporabniške poti', 'Žični okvirji (wireframe)', 'UI dizajn', 'Prototip', 'Design system'], vec: true, svoje: SVOJE_SPLOSNO },
    { id: 'osnova', label: 'Iz česa izhajamo?', izbire: ['Iz nič', 'Obstaja CGP', 'Obstaja star dizajn'], svoje: SVOJE_SPLOSNO },
    { id: 'test', label: 'Uporabniško testiranje?', izbire: ['Da', 'Ne', 'Svetuj mi'], svoje: SVOJE_SPLOSNO },
    { id: 'fonti', label: 'Pisave: je licenca za vgradnjo v aplikacijo urejena?', izbire: ['Da, urejena za app', 'Uporabimo odprtokodne (npr. Google Fonts)', 'Treba jo bo urediti', 'Ne vem še'], svoje: SVOJE_SPLOSNO },
    { id: 'budget', label: 'Okvirni budget naročnika?', izbire: ['Do 1.500 €', '1.500 do 4.000 €', 'Nad 4.000 €', 'Še ne vem'], svoje: 'ali vpiši svoj znesek ...' },
    { id: 'opomba', label: 'Opomba (neobvezno)', placeholder: 'karkoli, kar naj upoštevam vnaprej ...' },
  ],
  aplikacija: [
    { id: 'platforma', label: 'Za katere platforme?', izbire: ['iOS', 'Android', 'Oboje', 'Spletna (PWA)'], vec: true, svoje: SVOJE_SPLOSNO },
    ...
    { id: 'backend', label: 'Ali rabi backend ali bazo?', izbire: ['Da', 'Ne', 'Ne vem še'], svoje: SVOJE_SPLOSNO },
    { id: 'fonti', label: 'Pisave: je licenca za vgradnjo v aplikacijo urejena?', izbire: ['Da, urejena za app', 'Uporabimo odprtokodne (npr. Google Fonts)', 'Treba jo bo urediti', 'Ne vem še'], svoje: SVOJE_SPLOSNO },
    { id: 'budget', label: 'Okvirni budget naročnika?', izbire: ['Do 3.000 €', '3.000 do 8.000 €', 'Nad 8.000 €', 'Še ne vem'], svoje: 'ali vpiši svoj znesek ...' },
    { id: 'opomba', label: 'Opomba (neobvezno)', placeholder: 'karkoli, kar naj upoštevam vnaprej ...' },
  ],
  dizajnsistem: [
    { id: 'obseg', label: 'Kako obsežen sistem?', izbire: ['Osnovni (barve, tipografija, gumbi)', 'Srednji (komponente)', 'Obsežen (celotna knjižnica)'], svoje: SVOJE_SPLOSNO },
    { id: 'namen', label: 'Za kaj?', izbire: ['Spletna stran', 'Aplikacija', 'Več produktov', 'Znamka'], vec: true, svoje: SVOJE_SPLOSNO },
    { id: 'orodje', label: 'V katerem orodju?', izbire: ['Figma', 'Drugo'], svoje: 'katero ...' },
    { id: 'dokumentacija', label: 'Potrebna dokumentacija / navodila?', izbire: ['Da', 'Osnovna', 'Ne'], svoje: SVOJE_SPLOSNO },
    { id: 'budget', label: 'Okvirni budget naročnika?', izbire: ['Do 1.500 €', '1.500 do 4.000 €', 'Nad 4.000 €', 'Še ne vem'], svoje: 'ali vpiši svoj znesek ...' },
    { id: 'opomba', label: 'Opomba (neobvezno)', placeholder: 'karkoli, kar naj upoštevam vnaprej ...' },
  ],
  smm: [
    ...
    { id: 'storitve', label: 'Kaj vključuje?', izbire: ['Strategija', 'Vsebinski koledar', 'Oblikovanje objav', 'Copywriting', 'Odgovarjanje na komentarje', 'Oglaševanje'], vec: true, svoje: SVOJE_SPLOSNO },
    { id: 'gradiva', label: 'Kdo priskrbi fotografije in video?', izbire: ['Naročnik', 'Jaz', 'Kombinirano'], svoje: SVOJE_SPLOSNO },
    { id: 'trajanje', label: 'Za koliko časa?', izbire: ['Enkratno', '3-mesečno', '6-mesečno ali več'], svoje: SVOJE_SPLOSNO },
  ...
  seo: [
    { id: 'storitve', label: 'Kaj potrebuje?', izbire: ['Tehnični SEO audit', 'Optimizacija vsebin', 'Ključne besede', 'Povezave (linkbuilding)', 'Redno vodenje'], vec: true, svoje: SVOJE_SPLOSNO },
    { id: 'stran', label: 'Kakšna stran?', izbire: ['Predstavitvena', 'Spletna trgovina', 'Blog / portal'], svoje: 'dopiši ...' },
    { id: 'stanje', label: 'Trenutno stanje?', izbire: ['Nova stran', 'Obstoječa brez SEO', 'Že delano na SEO'], svoje: SVOJE_SPLOSNO },
    { id: 'trajanje', label: 'Enkratno ali redno?', izbire: ['Enkraten audit / optimizacija', 'Mesečno vodenje'], svoje: SVOJE_SPLOSNO },
    { id: 'budget', label: 'Okvirni budget naročnika?', izbire: ['Do 500 €', '500 do 1.500 €', 'Nad 1.500 €', 'Še ne vem'], svoje: 'ali vpiši svoj znesek ...' },
    { id: 'opomba', label: 'Opomba (neobvezno)', placeholder: 'karkoli, kar naj upoštevam vnaprej ...' },
  ],
  email: [
    { id: 'storitve', label: 'Kaj potrebuje?', izbire: ['Zasnova predloge', 'Postavitev v orodju', 'Pisanje vsebin', 'Avtomatizacije', 'Redno pošiljanje'], vec: true, svoje: SVOJE_SPLOSNO },
    { id: 'orodje', label: 'Katero orodje?', izbire: ['Mailchimp', 'MailerLite', 'Drugo', 'Nimajo še'], svoje: 'katero ...' },
    { id: 'pogostost', label: 'Kako pogosto?', izbire: ['Enkratno', 'Mesečno', 'Tedensko'], svoje: SVOJE_SPLOSNO },
    { id: 'baza', label: 'Imajo bazo naslovnikov?', izbire: ['Da', 'Ne', 'Gradimo jo'], svoje: SVOJE_SPLOSNO },
    { id: 'budget', label: 'Okvirni budget naročnika?', izbire: ['Do 400 €', '400 do 1.200 €', 'Nad 1.200 €', 'Še ne vem'], svoje: 'ali vpiši svoj znesek ...' },
    { id: 'opomba', label: 'Opomba (neobvezno)', placeholder: 'karkoli, kar naj upoštevam vnaprej ...' },
  ],
  pr: [
    { id: 'storitve', label: 'Kaj vključuje?', izbire: ['Sporočila za javnost', 'Odnosi z mediji', 'Krizno komuniciranje', 'Dogodki', 'Vsebine za medije'], vec: true, svoje: SVOJE_SPLOSNO },
    { id: 'obseg', label: 'Enkratno ali redno?', izbire: ['Enkraten projekt', '3-mesečno', '6-mesečno ali več'], svoje: SVOJE_SPLOSNO },
    { id: 'mediji', label: 'Kateri mediji?', izbire: ['Lokalni', 'Nacionalni', 'Panožni / strokovni', 'Spletni'], vec: true, svoje: SVOJE_SPLOSNO },
    { id: 'gradiva', label: 'Imajo pripravljena izhodišča?', izbire: ['Da', 'Delno', 'Ne'], svoje: SVOJE_SPLOSNO },
    { id: 'budget', label: 'Okvirni mesečni budget naročnika?', izbire: ['Do 800 €', '800 do 2.000 €', 'Nad 2.000 €', 'Še ne vem'], svoje: 'ali vpiši svoj znesek ...' },
    { id: 'opomba', label: 'Opomba (neobvezno)', placeholder: 'karkoli, kar naj upoštevam vnaprej ...' },
  ],
  video: [
    ...
    { id: 'storitve', label: 'Kaj prevzameš?', izbire: ['Scenarij', 'Snemanje', 'Montaža', 'Animacija', 'Zvok / glasba'], vec: true, svoje: SVOJE_SPLOSNO },
    { id: 'snemanje', label: 'Koliko snemalnih dni?', izbire: ['Brez snemanja', 'Pol dneva', '1 dan', '2 ali več'], svoje: SVOJE_SPLOSNO },
    { id: 'najem', label: 'Najem opreme, ekipe ali lokacije?', izbire: ['Ne', 'Da, oprema', 'Da, ekipa', 'Da, lokacija', 'Ne vem še'], vec: true, svoje: SVOJE_SPLOSNO },
  ...
  motion: [
    ...
    { id: 'gradiva', label: 'Ali obstajajo grafike / logotip?', izbire: ['Da', 'Delno', 'Ne, treba oblikovati'], svoje: SVOJE_SPLOSNO },
    { id: 'zvok', label: 'Potreben zvok ali glasba?', izbire: ['Da', 'Ne', 'Naročnik priskrbi'], svoje: SVOJE_SPLOSNO },
  ...
  render3d: [
    ...
    { id: 'gradiva', label: 'Ali obstajajo modeli / načrti?', izbire: ['Da', 'Delno', 'Ne, treba modelirati'], svoje: SVOJE_SPLOSNO },
    { id: 'kakovost', label: 'Namen?', izbire: ['Predstavitev / splet', 'Tisk', 'Fotorealizem za oglas'], svoje: SVOJE_SPLOSNO },
    { id: 'budget', label: 'Okvirni budget naročnika?', izbire: ['Do 900 €', '900 do 2.500 €', 'Nad 2.500 €', 'Še ne vem'], svoje: 'ali vpiši svoj znesek ...' },
    { id: 'opomba', label: 'Opomba (neobvezno)', placeholder: 'karkoli, kar naj upoštevam vnaprej ...' },
  ],
  strategija: [
    { id: 'obseg', label: 'Kaj vključuje?', izbire: ['Pozicioniranje', 'Ciljne skupine', 'Vrednote in ton', 'Ime / naming', 'Komunikacijska strategija'], vec: true, svoje: SVOJE_SPLOSNO },
    { id: 'faza', label: 'V kateri fazi je znamka?', izbire: ['Nova znamka', 'Prenova', 'Rast / širitev'], svoje: SVOJE_SPLOSNO },
    { id: 'delavnice', label: 'Delavnice z naročnikom?', izbire: ['Da', 'Ne', 'Po potrebi'], svoje: SVOJE_SPLOSNO },
    { id: 'izdelek', label: 'Kaj je rezultat?', izbire: ['Strateški dokument', 'Brand book', 'Oboje'], svoje: SVOJE_SPLOSNO },
