...
export const PODROCJA: PricingPodrocje[] = [
  ...
  { id: 'direkcija', ime: 'Kreativna direkcija / strategija', imeEn: 'Creative direction / strategy', opis: 'vodenje, koncept, strategija',             opisEn: 'management, concept, strategy',                            storitve: ['direkcija', 'strategija'] },
