  ...
  return (
    <div className={`cw${vLupini ? ' cw-lupina' : ''}${korak === zakljucekStep ? ' cw-zakljucek' : ''}`} onKeyDown={naEnter}>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .cw .chat-podrocja { display: inline-grid; grid-template-columns: repeat(2, auto); justify-content: start; align-items: start; gap: .7rem; margin: .5rem 0 .3rem 3.05rem; max-width: none; }
