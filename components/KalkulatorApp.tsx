  ...
  return (
    <div className={`cw${vLupini ? ' cw-lupina' : ''}${korak === zakljucekStep ? ' cw-zakljucek' : ''}`} onKeyDown={naEnter}>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        /* Za gumbom: "Kaj imas od tega" in prijava na obvescanje sta
           dodatka, ne pogoja. Prej sta stala NAD gumbom in na prenosniku
           si morala drsati, preden si sploh lahko zacela. */
        .cw .soglasje-kartica .sg-po-gumbu { margin-top: 1.6rem; }
        .cw .soglasje-kartica .soglasje-email { margin-top: 1.1rem; margin-bottom: 0; }
      ...
      {(pogojiOk === false || pogojiOdhaja) && typeof document !== 'undefined' && createPortal(
        ...
        <div className={`soglasje${pogojiOdhaja ? ' soglasje-odhaja' : ''}`} role="dialog" aria-modal="true" aria-label={L('Pogoji uporabe', 'Terms of use')}>
          <div className="soglasje-kartica">
            ...
            {!vFlow && (
            <div className="sg-motiv sg-po-gumbu">
