  ...
  return (
    <div className={`cw${vLupini ? ' cw-lupina' : ''}${korak === zakljucekStep ? ' cw-zakljucek' : ''}`} onKeyDown={naEnter}>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .cw .orb0:hover .zar0 { opacity: 1; filter: blur(4px); transform: scale(1.16); }
        .cw .orb0:hover { filter: brightness(1.12) saturate(1.14) drop-shadow(0 13px 28px rgba(40,25,60,.34)); z-index: 3; }
        ...
        .cw .ponudba0-chip { background: rgba(255,255,255,.85); border: 1px solid oklch(93% .006 82 / .55); border-radius: 999px; padding: .28rem .7rem; font-size: .74rem; font-weight: 650; color: rgba(17,17,17,.6); white-space: nowrap; }
        ...
        .cw .stepper0 button { width: 1.55rem; height: 1.55rem; border-radius: 50%; border: 1px solid oklch(93% .006 82 / .55); background: transparent; color: rgba(17,17,17,.6); cursor: pointer; font-size: .95rem; line-height: 1; display: flex; align-items: center; justify-content: center; transition: border-color .15s, color .15s; }
        ...
        .cw .vrst0-x { width: 1.55rem; height: 1.55rem; border-radius: 50%; border: 1px solid oklch(93% .006 82 / .55); background: transparent; color: rgba(17,17,17,.55); cursor: pointer; font-size: .95rem; line-height: 1; display: flex; align-items: center; justify-content: center; transition: border-color .15s, color .15s; }
        ...
        .cw .polje input { width: 100%; border: 1px solid oklch(93% .006 82 / .7); background: #fff; font-family: var(--font-sans), system-ui, sans-serif; font-weight: 600; font-size: 1.05rem; padding: .65rem .85rem; color: var(--ink); border-radius: 10px; box-shadow: 0 3px 10px rgba(40,25,40,.045); transition: border-color .18s; box-sizing: border-box; }
        ...
        .cw .vp-svoje, .cw .basegrid input, .cw .cene-dodaj input, .cw .cene-vrsta input, .cw .paket-cena-uredi input, .cw .postavka input, .cw .prav-cena-uredi input, .cw .strosek-vrsta input, .cw .uredi-dodaj input, .cw .podjetja-shrani input {
          border: 1px solid oklch(93% .006 82 / .7) !important; border-radius: 10px !important; background: #fff !important; box-shadow: 0 3px 10px rgba(40,25,40,.045) !important; padding: .55rem .75rem !important; }
