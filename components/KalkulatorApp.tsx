  ...
  return (
    <div className={`cw${vLupini ? ' cw-lupina' : ''}${korak === zakljucekStep ? ' cw-zakljucek' : ''}`} onKeyDown={naEnter}>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .cw .profil-predal :is(input, select, textarea) { padding-left: 10px; padding-right: 10px; }
        .cw .profil-predal .chip-podrocje { padding: .5rem 10px; }
        .cw .profil-predal .cenik-card > summary,
        .cw .profil-predal .cenik-card .cenik-telo,
        .cw .profil-predal .cenik-post,
        .cw .profil-predal .uv-polje,
        .cw .profil-predal .polje { padding-left: 10px; padding-right: 10px; }
        ...
        .cw .profil-predal { position: fixed; top: 0; right: 0; bottom: 0; z-index: 66; width: min(440px, 100vw); background: var(--paper); box-shadow: -12px 0 40px rgba(17,17,17,.14); overflow-y: auto; padding: 20px 10px; padding-bottom: 5rem; animation: cwPredalIn .32s cubic-bezier(0.23,1,0.32,1) both; }
