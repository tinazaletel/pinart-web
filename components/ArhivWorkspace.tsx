  ...
  return (
    <div className="arh">
      ...
      <style>{`
        ...
        /* mobile: SAMO naslov+podnaslov zamaknjen na 1.41rem (ws .35 + 1.06); tabela/seznam ostane širok */
        @media (max-width:640px){.arh-kicker,.arh-h1,.arh-uvod{padding-left:1.06rem;padding-right:1.06rem}}
