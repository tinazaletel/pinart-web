  ...
  return (
    <div className="pw-aurora" aria-hidden>
      ...
      <style>{`
        ...
        .pw-aurora-modra { bottom: -22vh; right: -14vw; background: radial-gradient(circle, oklch(80% .17 162 / .85), transparent 66%); opacity: .46; animation: pwAuroraModra 14s ease-in-out infinite; }
        .pw-aurora-vijola { top: 14vh; left: 34vw; background: radial-gradient(circle, oklch(70% .22 288 / .85), transparent 66%); opacity: .42; animation: pwAuroraVijola 10s ease-in-out infinite; }
