      ...
      <section className={styles.flowBand} id="tools" aria-labelledby="tools-title">
        ...
        <div className={styles.flowTools}>
          <Link className={styles.offerTool} href={`${base}/kalkulator/orodje`}>
            <span>01</span><ToolIcon type="offer" /><strong>Ponudba</strong><small>Pametna cena je vključena</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i>
          </Link>
          <Link href={`${base}/kalkulator/dolgorocno`}><span>02</span><ToolIcon type="contract" /><strong>Dolgoročno sodelovanje</strong><small>Mesečni retainer — ponudba in pogodba</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
          <Link href={`${base}/kalkulator/pogodbe`}><span>03</span><ToolIcon type="pogodba" /><strong>Pogodba</strong><small>Iz ponudbe ali dokument stranke</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
          <Link href={`${base}/kalkulator/racuni`}><span>04</span><ToolIcon type="invoice" /><strong>Račun</strong><small>Iz ponudbe ali na novo</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
          <Link href={`${base}/kalkulator/stroski`}><span>05</span><ToolIcon type="expense" /><strong>Strošek</strong><small>Projekt, podjetje ali naročnina</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
          <Link href={`${base}/kalkulator/ceniki`}><span>06</span><ToolIcon type="prices" /><strong>Moji ceniki</strong><small>Profili cen in tvoje storitve</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
          <Link href={`${base}/kalkulator/cas`}><span>07</span><ToolIcon type="time" /><strong>Cena &amp; čas</strong><small>Zasebni timer in donosnost dela</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
          <Link href={`${base}/kalkulator/poslovni-nacrt`}><span>08</span><ToolIcon type="plan" /><strong>Poslovni načrt</strong><small>Business Canvas in vodeni načrt</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
        </div>
      </section>
