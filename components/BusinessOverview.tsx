    ...
    <>
      ...
      <section className={styles.flowBand} id="tools" aria-labelledby="tools-title">
        ...
        <div className={styles.flowTools}>
          ...
          <Link href={`${base}/kalkulator/racuni`}><b className={styles.cardBubbles} aria-hidden><u /><u /><u /><u /></b><span>02</span><strong>Račun</strong><small>Iz ponudbe ali na novo</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
          <Link href={`${base}/kalkulator/nov-projekt`}><b className={styles.cardBubbles} aria-hidden><u /><u /><u /><u /></b><span>03</span><strong>Ustvari projekt</strong><small>Nov projekt za stranko</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
          <Link href={`${base}/kalkulator/stranke`}><b className={styles.cardBubbles} aria-hidden><u /><u /><u /><u /></b><span>04</span><strong>Stranke</strong><small>Kartoteka in zgodovina sodelovanja</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
          <Link href={`${base}/kalkulator/koledar`}><b className={styles.cardBubbles} aria-hidden><u /><u /><u /><u /></b><span>05</span><strong>Koledar</strong><small>Sestanki, klici in roki projektov</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
          <Link href={`${base}/kalkulator/naloge`}><b className={styles.cardBubbles} aria-hidden><u /><u /><u /><u /></b><span>06</span><strong>Naloge</strong><small>Opravila in podnaloge po projektih</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
          <Link href={`${base}/kalkulator/cas`}><b className={styles.cardBubbles} aria-hidden><u /><u /><u /><u /></b><span>07</span><strong>Cena &amp; čas</strong><small>Zasebni timer in donosnost dela</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
          <Link href={`${base}/kalkulator/pogodbe`}><b className={styles.cardBubbles} aria-hidden><u /><u /><u /><u /></b><span>08</span><strong>Pogodba</strong><small>Iz ponudbe ali dokument stranke</small><i><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M5 12h14M13 6l6 6-6 6" /></svg></i></Link>
        </div>
      </section>
