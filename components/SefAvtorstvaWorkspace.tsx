    ...
    <div className="sef">
      ...
      <style jsx>{`
        ...
        /* vsebina (uvod + kartice) poravnana z naslovom (1.41rem = workspace .35 + 1.06); .sef je imel horizontalni padding 0.
           Kartice pa bleedajo bliže robu (-.5 = ~0.91rem) + manjši padding/radij, kot ponudba. */
        @media (max-width: 640px) {
          .sef { padding-left: 1.06rem; padding-right: 1.06rem; box-sizing: border-box; }
          .sef-kako-mreza { margin-left: -.5rem; margin-right: -.5rem; }
          .sef-kako-kartica { padding: 1.1rem; border-radius: 14px; }
        }
