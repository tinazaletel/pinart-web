...
export default function Pupa() {
  ...
  return createPortal(
    <>
      ...
      <style>{'.pupa-fab-mini{display:none}@media (max-width:760px){.pupa-fab{top:.5rem!important;bottom:auto!important;right:4.4rem!important;width:40px!important;height:40px!important;background:#fff!important;border:1px solid rgba(42,32,53,.18)!important;box-shadow:0 4px 12px rgba(42,32,53,.16)!important;display:flex!important;align-items:center!important;justify-content:center!important}.pupa-fab .pupa-fab-full{display:none!important}.pupa-fab .pupa-fab-mini{display:block!important}}'}</style>
      {!odprt && (
