...
export default function Pupa() {
  ...
  return createPortal(
    <>
      <style>{'.pupa-fab{transition:opacity .22s ease, transform .22s ease}body.pw-sheet-open .pupa-fab,body[data-detajl-odprt] .pupa-fab{opacity:0;transform:scale(.5);pointer-events:none}'}</style>
      {!odprt && (
