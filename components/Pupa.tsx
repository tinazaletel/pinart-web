...
export default function Pupa() {
  ...
  return createPortal(
    <>
      {/* Plavajoči orb umaknjen: Pupo odpira sparkle (✨) ikona v glavi (z nadgradnjo za free).
          Panel ostane in se odpre prek 'pupa:odpri'. */}
      <style>{'.pupa-fab{display:none!important}'}</style>
      {!odprt && (
