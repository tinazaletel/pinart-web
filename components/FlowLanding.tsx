  ...
  return (
    <div className="fl">
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .fl-footer-logo i { width: 1.1rem; height: 1.1rem; border-radius: 50%; flex: none; background: linear-gradient(155deg, oklch(62% .2 288) 0%, oklch(72% .16 350) 50%, oklch(76% .16 55) 100%); }
