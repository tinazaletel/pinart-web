    ...
    <div className="fl" ref={flRef}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media (max-width: 640px) {
          ...
          .fl-kalk-lik-img.a { transform: scale(1.2) !important; transform-origin: right bottom; }
          .fl-kalk-lik-img.b { transform: translateX(26px) scale(.82) !important; transform-origin: right bottom; }
