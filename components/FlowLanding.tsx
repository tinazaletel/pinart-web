  ...
  return (
    <div className="fl" ref={flRef}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .fl-kalk-lik-img.a { animation: flLikA 9s ease-in-out infinite; transform: scale(1.14); transform-origin: right bottom; }
        ...
        <section className="fl-kalk-banner">
          <div className="fl-kalk-banner-in">
            ...
            <div className="fl-kalk-lik" aria-hidden>
              <img src="/flow/pupa_sedi.png?v=4" alt="" className="fl-kalk-lik-img a" />
              <img src="/flow/pupa_zamisljena.png?v=4" alt="" className="fl-kalk-lik-img b" />
            </div>
