...
export default function FlowLanding({ locale = 'sl' }: { locale?: string }) {
  ...
  const CENIKI = isEn ? [
    ...
    { ime: 'Premium', za: 'For regular client work', cena: '15', cenaMes: '18', enota: '€ / month', ustanovna: 'Founding price: €9/month for the first 50 users (limited time) · first month free', cta: 'Coming soon', href: localePath(locale, '/kalkulator/prijava'), izpost: true, znacka: 'Most popular', kmalu: true, vkljuceno: ['Everything in Free', 'Connect your own AI (ChatGPT, Claude, Gemini) — Pupa runs on your key', '1 GB attachment storage', 'Attendance log — arrival, break, departure and export', 'Saved proposals, contracts and invoices', 'Retainers', 'Projects and archive', 'Client CRM and price lists', 'Expenses and goals', 'Tasks, calendar and time tracking', 'Business dashboard'] },
    { ime: 'Pro', za: 'For small studios and collaborators', cena: '29', cenaMes: '35', enota: '€ / month', cta: 'Coming soon', href: localePath(locale, '/kalkulator/prijava'), izpost: false, znacka: 'Soon', kmalu: true, vkljuceno: ['Everything in Premium', 'Pupa AI assistant — 800 messages a month, text and voice', '5 GB attachment storage', 'Anonymous market comparison', 'Revenue and profit analytics by client', 'Advanced Pupa task planning', 'Business framework and taxes', 'Accounting export', 'Project-level collaborator access', 'Bring your own agent (MCP) + data export', 'Priority support'] },
  ] : [
    {
    ...
    },
    {
      ...
      vkljuceno: ['Vse iz Brezplačno', 'Poveži svoj AI (ChatGPT, Claude, Gemini) — Pupa dela s tvojim ključem', '1 GB prostora za priponke', 'Delovna prisotnost po ZEPDSV — prihod, odmor, odhod in izvoz', 'Ponudbe, pogodbe in računi (shranjeni, oštevilčeni)', 'Dolgoročni retainerji', 'Projekti & arhiv — vse na enem projektu', 'Kartoteka strank (CRM)', 'Ceniki (cenovni profili)', 'Stroški in cilji', 'Task manager: naloge in podnaloge', 'Koledar', 'Merjenje časa — ali se ti je delo splačalo', 'Nadzorna plošča'],
    },
    {
      ...
      vkljuceno: ['Vse iz Premium', 'AI asistentka Pupa — 800 sporočil na mesec, klepet in glas', '5 GB prostora za priponke', 'Primerjava s trgom — koliko za to zaračunajo drugi', 'Celoten analitični pregled — prihodki in dobiček po strankah', 'Napredna Pupa: sama razdeli naloge iz tvojih želja', 'Sinhronizacija med vsemi orodji', 'Poslovni okvir in davki', 'Posredovanje računovodstvu (izvoz)', 'Sodelavci z dostopom samo do izbranih projektov', 'Poveži svojega agenta (MCP) + izvoz podatkov', 'Prednostna podpora'],
    },
  ];
