...
export default function FlowLanding({ locale = 'sl' }: { locale?: string }) {
  ...
  const CENIKI = [
    ...
    },
    {
      ...
      vkljuceno: ['Vse iz Premium', 'Samodejni pregled prihodkov in dobička', 'Dolgoročni retainerji', 'Poslovni okvir in davki', 'Izvoz za računovodstvo', 'AI agent (beta)', 'MCP & API dostop (kmalu)', 'Prednostna podpora'],
      brez: [],
    },
  ];
