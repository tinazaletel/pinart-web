...
/* odtenek statusa = enak jezik kot drugod (pilula s piko, barve nadzorne plošče) */
const docTone = (s: string): 'success' | 'waiting' | 'danger' | 'neutral' => {
