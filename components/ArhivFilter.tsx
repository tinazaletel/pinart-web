  ...
  return <div className="af">
    ...
    <style>{`
      ...
      @media (min-width:641px){
        ...
        .af-poln-overlay{position:absolute;inset:0;z-index:6;display:flex;align-items:center;gap:.35rem;padding:0 .5rem 0 .85rem;border:1px solid var(--purple,oklch(66% 0.2 297));border-radius:999px;background-color:var(--paper,#fff)}
      ...
      .af-status:focus-within{border-color:var(--purple,oklch(66% 0.2 297));box-shadow:0 0 0 2.5px color-mix(in oklch,var(--purple,oklch(66% 0.2 297)) 42%,transparent)}
