...
export default function ProjectsWorkspace({ base }: { base: string }) {
  ...
  /* Detajl projekta se izriše v .projectStory panelu. Na mobilnem (≤980px) je ta panel POD seznamom,
     zato klik navidezno »ne naredi nič«. Ob izbiri ga zdrsnemo v pogled, da je učinek klika viden. */
