...
.pw-link-vrstica{display:inline-flex;align-items:center;gap:.4rem;max-width:100%;padding:.4rem .5rem .4rem .7rem;border:1px solid var(--line);border-radius:999px;background:oklch(100% 0 0 / .55)}
...
.pw-link-brisi{flex:none;display:grid;place-items:center;width:1.2rem;height:1.2rem;padding:0;border:1px solid var(--line);border-radius:50%;background:transparent;color:var(--muted);font-size:.72rem;line-height:1;cursor:pointer}
